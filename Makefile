...
BUILD_FLAGS ?= -DZENOH_ZEPHYR=1 -DZENOH_DEBUG=2 -DCONFIG_PTHREAD_IPC=y -DCONFIG_NET_SOCKETS_POSIX_NAMES=y 
all:
	...
	$(CC) -c $(CFLAGS) ${BUILD_FLAGS} -MD -Iinclude src/net/codec.c -o $(OBJ_DIR)/codec.o
